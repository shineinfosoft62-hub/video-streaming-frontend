...
function AppPhoneInput({
  ...
  const inputColor = useColorModeValue('#172033', 'white')
  const borderColor = useColorModeValue('rgba(0, 0, 0, 0.16)', 'rgba(255, 255, 255, 0.2)')
  const hoverBg = useColorModeValue('#e6f0ed', 'rgba(255,255,255,0.14)')
  const dropdownBg = useColorModeValue('white', '#111827')
  const mutedColor = useColorModeValue('#687587', 'rgba(255,255,255,0.64)')
