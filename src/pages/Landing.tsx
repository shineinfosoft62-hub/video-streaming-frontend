...
function Landing() {
  ...
  const outlineHoverBg = useColorModeValue('blackAlpha.50', 'whiteAlpha.100')
  const aboutBg = useColorModeValue(
    'linear-gradient(135deg, #ffffff 0%, #eef8f6 52%, #fff1f2 100%)',
    'linear-gradient(135deg, #111827 0%, #251026 50%, #111827 100%)',
  )
  const featureBg = useColorModeValue('rgba(255,255,255,0.78)', 'rgba(255,255,255,0.08)')
  const contactOverlay = useColorModeValue(
    'linear-gradient(180deg, rgba(248,250,252,0.9), rgba(248,250,252,0.82))',
    'linear-gradient(180deg, rgba(11,13,18,0.94), rgba(11,13,18,0.82))',
  )
  const contactCardBg = useColorModeValue('rgba(255, 255, 255, 0.84)', 'rgba(13, 16, 24, 0.82)')
  const footerBg = useColorModeValue('#ffffff', '#05070c')
  ...
  return (
      ...
      >
        ...
        >
          <Box>
            ...
            <Text mt={7} maxW="620px" fontSize="lg" lineHeight="8" color={mutedColor}>
        ...
        <Container maxW="7xl" px={0}>
          ...
          >
            <Box>
              ...
              <Text mt={6} maxW="560px" color={mutedColor} lineHeight="8">
          ...
          <SimpleGrid mt={12} columns={{ base: 1, md: 3 }} spacing={5}>
            {features.map((feature, index) => (
              <Box
                ...
                border="1px solid"
                borderColor={borderColor}
                bg={index === 1 ? '#e11d48' : featureBg}
                color={index === 1 ? 'white' : pageColor}
                p={7}
                boxShadow="xl"
              >
                <Text
                ...
                <Text
                  mt={4}
                  lineHeight="7"
                  color={index === 1 ? 'whiteAlpha.800' : mutedColor}
                >
                  {feature.description}
                </Text>
              </Box>
      ...
      <Box
        ...
        px={{ base: 5, md: 8 }}
        py={{ base: 16, lg: 24 }}
        bgImage={`${contactOverlay}, url(https://images.unsplash.com/photo-1522869635100-9f4c5e86aa37?auto=format&fit=crop&w=1800&q=80)`}
        bgSize="cover"
        bgPosition="center"
        ...
        <Container maxW="7xl" px={0}>
          ...
          >
            ...
            >
              ...
              <Text mt={6} maxW="xl" lineHeight="8" color="whiteAlpha.800">
...
function StreamingWall() {
  const frameBg = useColorModeValue('#e2e8f0', '#171923')
  const cardBg = useColorModeValue('rgba(255,255,255,0.94)', 'rgba(255,255,255,0.94)')
